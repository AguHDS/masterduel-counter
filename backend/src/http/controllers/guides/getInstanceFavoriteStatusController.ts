 ...
 */
export const getInstanceFavoriteStatusController = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
    ...
    const favorited = await instanceService.hasUserFavoritedInstance(
      instanceIdNum,
      userId,
    );
    ...
    console.error("Error getting instance favorite status:", error);
