...
async function resetDatabase() {
  try {
    ...
    try {
      ...
      console.log(`${e} ℹ Table card_pair_top doesn't exist yet (will be created after db push)`);
    }
    ...
    try {
      ...
      console.log(`${e} ℹ Table card_pair_bottom doesn't exist yet (will be created after db push)`);
    }
    ...
    try {
      ...
      console.log(`${e} ℹ Table archetype_card_pairs doesn't exist yet (will be created after db push)`);
    }
    ...
    try {
      ...
      console.log(`${e} ℹ Table instance_likes doesn't exist yet (will be created after db push)`);
    }
    ...
    try {
      ...
      console.log(`${e} ℹ Table archetype_instances doesn't exist yet (will be created after db push)`);
    }
    ...
    try {
      ...
      console.log(`${e} ℹ Table cards doesn't exist yet (will be created after db push)`);
    }
    ...
    try {
      ...
      console.log(`${e} ℹ Table archetypes doesn't exist yet (will be created after db push)`);
    }
    ...
    try {
      ...
      console.log(`${e} ℹ Table profiles doesn't exist yet (will be created after db push)`);
    }
    ...
    try {
      ...
      console.log(`${e} ℹ Table verification doesn't exist yet (will be created after db push)`);
    }
    ...
    try {
      ...
      console.log(`${e} ℹ Table session doesn't exist yet (will be created after db push)`);
    }
    ...
    try {
      ...
      console.log(`${e} ℹ Table account doesn't exist yet (will be created after db push)`);
    }
    ...
    try {
      ...
      console.log(`${e} ℹ Table user doesn't exist yet (will be created after db push)`);
    }
