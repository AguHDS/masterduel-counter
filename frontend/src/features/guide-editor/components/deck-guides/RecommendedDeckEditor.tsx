...
export const RecommendedDeckEditor = ({
  ...
  return (
    <div className="mt-8 flex flex-wrap items-stretch justify-center gap-4 max-[700px]:-mx-4 max-[700px]:sm:-mx-6">
      <div className="relative w-full min-[851px]:w-[75%] min-[1024px]:w-[85%] min-[1200px]:w-[62%] rounded-md border border-blue-500/45 bg-gradient-to-br from-[#090d18] via-[#13182b] to-[#190f30] p-4 shadow-[0_0_44px_rgba(37,99,235,0.16)] sm:p-5 max-[400px]:p-3">
