            ...
            <div key={slotIndex} className="relative group">
              {isDeckLoading ? (
                  ...
                  {isEditMode && (
                    <div className="absolute top-1.5 right-1.5 flex gap-1 z-10 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button
                        ...
                        className="p-1.5 bg-blue-600/90 hover:bg-blue-700 rounded-full shadow"
                      >
                        <Edit className="w-3 h-3 text-white" />
                      </button>
                      <button
                        onClick={(e) => { e.stopPropagation(); handleRemoveDeck(slotIndex); }}
                        className="p-1.5 bg-red-600/90 hover:bg-red-700 rounded-full shadow"
                      >
                ...
                <button
                  ...
                  className="w-full aspect-[12/9] rounded-lg border-2 border-dashed border-yellow-600/40 bg-purple-950/20 hover:border-yellow-500/70 hover:bg-purple-950/40 flex flex-col items-center justify-center gap-2"
                >
                  <Edit className="w-6 h-6 text-yellow-500/70" />
                  <p className="text-yellow-400/80 text-sm font-semibold">Add Deck</p>
                </button>
              ) : (
                <div className="w-full aspect-[12/9] rounded-lg border border-yellow-600/15 bg-purple-950/15 flex items-center justify-center">
