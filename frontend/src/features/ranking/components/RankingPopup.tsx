...
export const RankingPopup: React.FC<RankingPopupProps> = ({
  ...
  return (
    <div
      ...
      className="absolute mt-2 w-[499px] max-w-[calc(100vw-2rem)] border border-[#c2901c]/40 rounded-xl overflow-hidden z-50 left-1/2 -translate-x-1/2 sm:left-auto sm:right-0 sm:translate-x-0 lg:left-1/2 lg:-translate-x-1/2 lg:right-auto"
      style={{
        top: "100%",
        background:
          ...
          <>
            ...
            {!currentLoading &&
              currentData.map((item) => {
                ...
                const trendingUser = user as TrendingRankingUser;
                const monthlyViews =
          ...
          <>
            ...
            {!currentLoading &&
              currentData.map((item) => {
                ...
                const trendingGuide = guide as TrendingRankingGuide;
                const monthlyViews =
