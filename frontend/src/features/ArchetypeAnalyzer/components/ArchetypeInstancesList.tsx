    ...
    <div className="flex flex-col items-center p-8">
      ...
      <div className="w-[90%] bg-gradient-to-br from-slate-800 to-slate-900 rounded-lg shadow-xl p-6">
        <div className="w-[95%] mx-auto">
          <div className="grid grid-cols-[60px_40px_1fr_1fr_150px_100px] gap-3 mb-4 pb-3 border-b border-blue-600">
            ...
            {currentInstances.map((instance, index) => {
              ...
              return (
                <button
                  ...
                  className={`w-full grid grid-cols-[50px_40px_1fr_1fr_130px_100px] gap-3 py-2 px-3 rounded transition-colors text-left items-center h-12 ${
                    isCurrentUser 
                  ...
                  <div className="flex items-center justify-start h-full">
                    {instance.headerCardImageUrl ? (
                      <img
                        ...
                        className="h-9 relative right-10 bottom-[2px] w-auto object-contain rounded border border-blue-500 shadow-sm"
                      />
                    ) : (
