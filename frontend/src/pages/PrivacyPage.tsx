...
import { PrivacyContent } from "../shared/components/info";

export const PrivacyPage = () => {
  return (
    <>
      <Helmet>
        <title>Privacy Policy - Masterduel Counter</title>
        <meta
          name="description"
          content="Privacy Policy for Masterduel Counter, the community platform for creating and discovering Yu-Gi-Oh! archetype counter guides and deck guides."
        />
      </Helmet>
